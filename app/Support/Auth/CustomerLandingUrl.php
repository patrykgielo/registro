 ...
 * Until VULN-003 Layer 8 (2026-08-31), that helper fell back to
 * session('tenant_id') and would resolve whichever tenant subdomain this
 * browser last happened to visit, not the tenant this login actually belongs
 * to; that fallback branch is now gone from every real HTTP request (only a
 * narrow Livewire::test()-only escape hatch remains), but the request
 * attribute remains the correct, request-scoped source here regardless.
 */
