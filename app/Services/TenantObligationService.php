...
class TenantObligationService
{
     ...
     *
     * - appointments: status in (pending, confirmed) — AppointmentStatus::isActive()
     * - orders: status NOT IN (cancelled, refunded) — terminal states per OrderStatusStateMachine
