...
@section('title', 'Strona w przygotowaniu')
...
<div class="container mx-auto px-4 py-24 text-center">
    ...
    <h1 class="text-3xl font-bold text-gray-900 mb-2">Strona w przygotowaniu</h1>
    <p class="text-gray-600 mb-6">Wróć do nas wkrótce.</p>
