...
class EmailTemplateSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $templates = [
            ...
            [
                'key' => TemplateKey::ADMIN_DAILY_DIGEST->value,
                'language' => 'pl',
            ...
            [
                'key' => TemplateKey::EMAIL_CHANGE_REQUESTED->value,
                'language' => 'pl',
            ...
            [
                'key' => TemplateKey::EMAIL_CHANGE_VERIFICATION->value,
                'language' => 'pl',
            ...
            [
                'key' => TemplateKey::EMAIL_CHANGE_COMPLETED->value,
                'language' => 'pl',
            ...
            [
                'key' => TemplateKey::ACCOUNT_DELETION_REQUESTED->value,
                'language' => 'pl',
            ...
            [
                'key' => TemplateKey::ACCOUNT_DELETION_COMPLETED->value,
                'language' => 'pl',
            ...
            // Order Accepted Offline - Customer Confirmation, "pay at pickup" (Polish)
            [
                'key' => TemplateKey::ORDER_ACCEPTED_OFFLINE->value,
                'language' => 'pl',
...
Pozdrawiamy, Zespół {{app_name}}',
                'blade_path' => null,
                'variables' => ['customer_name', 'order_number', 'total_amount', 'hold_until', 'orders_url', 'app_name', 'items_list_html', 'items_list_text', 'deposit_amount', 'pickup_address', 'pickup_phone'],
                'active' => true,
            ],
            // Order Accepted Offline - Customer Confirmation, "pay at pickup" (English)
            [
                'key' => TemplateKey::ORDER_ACCEPTED_OFFLINE->value,
                'language' => 'en',
