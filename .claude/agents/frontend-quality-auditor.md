...
description: Audits frontend code quality before deployment or review. Covers animation performance (non-GPU properties that cause jank), WCAG 2.2 AA accessibility, critical CSS and lazy loading, container queries and @layer organisation, Livewire-compatible component architecture, and hardcoded values that should be design tokens.
