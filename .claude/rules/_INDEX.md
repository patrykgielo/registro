...
- `architecture-models.md` → `ResolveTenant.php`, `app/Notifications/**`, `app/Jobs/**`, `config/app.php`, `scripts/server/**`, `app/Support/LocationContext.php` — stack współdzielony vs dedykowany; **oba chcą przeciwnego kodu**. Pomiar: `scripts/architecture-facts.sh`
