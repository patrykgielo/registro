...
| [Ścieżka klienta — Wybór oddziału](customer-journey-locations.md) | **Częściowo wdrożone (fazy 0-2).** Oddział z adresem, godzinami i galerią jest widoczny na stronie. Wybór oddziału i dostępność per punkt — zaplanowane |
| [Ścieżka pracownika — Praca w oddziale](staff-journey-locations.md) | **Planowane (Faza 8).** Przypisanie do oddziału, wydanie i zwrot, przeniesienia sprzętu między punktami |
