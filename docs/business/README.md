...
| [Ścieżka klienta — Wybór oddziału](customer-journey-locations.md) | **Planowane.** Wielooddziałowość: wybór oddziału, dostępność per punkt, jedno zamówienie = jeden odbiór |
| [Ścieżka pracownika — Praca w oddziale](staff-journey-locations.md) | **Planowane.** Przypisanie do oddziału, wydanie i zwrot, przeniesienia sprzętu między punktami |
