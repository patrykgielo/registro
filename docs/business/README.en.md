...
| [Customer Journey — Choosing a Branch](customer-journey-locations.en.md) | **Partially implemented (phases 0-2).** Branches with address, hours and gallery are live on the website. Branch selection and per-site availability are planned |
| [Staff Journey — Working at a Branch](staff-journey-locations.en.md) | **Planned (phase 8).** Branch assignment, handover and return, moving equipment between sites |
